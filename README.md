...
* [Zivid SDK][zivid-download-software-url] version 2.4.0 (see [here][zivid-software-installation-url] for help)
...
| :--------------- | :------------------| :---------------- |
| Ubuntu 20.04     | 3.8                | 2.4.0             |
| Ubuntu 18.04     | 3.6                | 2.4.0             |
| Fedora 30        | 3.7                | 2.4.0             |
| Fedora 33        | 3.9                | 2.4.0             |
| Windows 10       | 3.6, 3.7, 3.8, 3.9 | 2.4.0             |
| Arch Linux       | latest             | 2.4.0             |

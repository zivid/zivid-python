...
def test_fixed_placement_of_fiducial_marker():
    marker = zivid.experimental.hand_eye_low_dof.FixedPlacementOfFiducialMarker(
        0, [1, 2, 3]
    )
    ...
    with pytest.raises(TypeError):
        zivid.experimental.hand_eye_low_dof.FixedPlacementOfFiducialMarker(
            0, [1, 2, 3, 4]
        )
    with pytest.raises(TypeError):
        zivid.experimental.hand_eye_low_dof.FixedPlacementOfFiducialMarker(
...
def test_fixed_placement_of_fiducial_markers():
    marker1 = zivid.experimental.hand_eye_low_dof.FixedPlacementOfFiducialMarker(
        0, [1, 2, 3]
    )
    marker2 = zivid.experimental.hand_eye_low_dof.FixedPlacementOfFiducialMarker(
        1, [4, 5, 6]
    )
...
def test_fixed_placement_of_calibration_board():
    calibration_board = (
        zivid.experimental.hand_eye_low_dof.FixedPlacementOfCalibrationBoard([1, 2, 3])
    )
...
def test_fixed_placement_of_calibration_objects():
    ...
    calibration_objects = (
        zivid.experimental.hand_eye_low_dof.FixedPlacementOfCalibrationObjects(
            calibration_board
        )
    )
    ...
    calibration_objects = (
        zivid.experimental.hand_eye_low_dof.FixedPlacementOfCalibrationObjects(markers)
    )
    assert (
...
def test_eye_to_hand_low_dof_calibration_with_calibration_board(
    ...
    handeye_output = zivid.experimental.hand_eye_low_dof.calibrate_eye_to_hand_low_dof(
        inputs, fixed_objects
    )
    pytest.helpers.check_handeye_output(
        inputs, handeye_output, handeye_eth_low_dof_transform
    )
...
def test_eye_to_hand_low_dof_calibration_with_markers(
    ...
    pytest.helpers.check_handeye_output(
        inputs, handeye_output, handeye_eth_low_dof_markers_transform
    )
...
def test_eye_in_hand_low_dof_calibration_with_eye_to_hand_data(
    ...
    with pytest.raises(RuntimeError):
        handeye_output = (
            zivid.experimental.hand_eye_low_dof.calibrate_eye_to_hand_low_dof(
                inputs, fixed_objects
            )
        )

...
def test_suggest_settings_parameters():
    ...
    assert suggest_settings_parameters.ambient_light_frequency == SuggestSettingsParameters.AmbientLightFrequency.hz50
...
def test_init_max_capture_time():
    suggested_settings = SuggestSettingsParameters(max_capture_time=datetime.timedelta(milliseconds=1000))
...
def test_default_ambient_light_frequency():
    suggested_settings = SuggestSettingsParameters(max_capture_time=datetime.timedelta(milliseconds=250))
    ...
    assert ambient_light_frequency == SuggestSettingsParameters.AmbientLightFrequency.none


def test_set_ambient_light_frequency():
    suggested_settings = SuggestSettingsParameters()

    suggested_settings.ambient_light_frequency = SuggestSettingsParameters.AmbientLightFrequency.hz50
    assert suggested_settings.ambient_light_frequency == SuggestSettingsParameters.AmbientLightFrequency.hz50
    assert suggested_settings.ambient_light_frequency == "hz50"
    assert isinstance(suggested_settings.ambient_light_frequency, str)

    suggested_settings.ambient_light_frequency = SuggestSettingsParameters.AmbientLightFrequency.hz60
    assert suggested_settings.ambient_light_frequency == SuggestSettingsParameters.AmbientLightFrequency.hz60
    assert suggested_settings.ambient_light_frequency == "hz60"
    assert isinstance(suggested_settings.ambient_light_frequency, str)

    suggested_settings.ambient_light_frequency = SuggestSettingsParameters.AmbientLightFrequency.none
    assert suggested_settings.ambient_light_frequency == SuggestSettingsParameters.AmbientLightFrequency.none

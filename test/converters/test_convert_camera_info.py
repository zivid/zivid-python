...
def test_to_internal_camera_info_to_camera_info_modified():
    ...
    converted_camera_info = _to_camera_info(_to_internal_camera_info(modified_camera_info))
...
def test_to_internal_camera_info_to_camera_info_default():
    ...
    converted_camera_info = _to_camera_info(_to_internal_camera_info(default_camera_info))

...
install_www_deb https://www.zivid.com/hubfs/softwarefiles/releases/2.0.0-beta-1+6b13d5ad-356/u16/zivid-telicam-driver_3.0.1.1-2_amd64.deb || exit $?
install_www_deb https://www.zivid.com/hubfs/softwarefiles/releases/2.0.0-beta-1+6b13d5ad-356/u16/zivid_2.0.0-beta-1+6b13d5ad-356_amd64.deb || exit $?

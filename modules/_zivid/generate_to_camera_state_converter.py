...
def start_traverse():
    from _zivid._zivid import CameraState as InternalCameraState
    from zivid import CameraInfo

    data_model = _recursion(InternalCameraState, indentation_level=0)
    with tempfile.NamedTemporaryFile(suffix=".py") as temp_file:
        ...
        raw_text += create_to_not_internal_converter(
            data_model, settings_type="CameraState"
        )

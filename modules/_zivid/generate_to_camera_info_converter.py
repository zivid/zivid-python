...
def start_traverse():
    from _zivid._zivid import CameraInfo as Internal

    # from zivid import Settings

    data_model = _recursion(Internal, indentation_level=0)
    with tempfile.NamedTemporaryFile(suffix=".py") as temp_file:
        ...
        raw_text += create_to_not_internal_converter(
            data_model, settings_type="CameraInfo"
        )
...
#     return_class = "zivid.CameraInfo{path}".format(
